...
> **Note**: This is a fork of [@orengrinker/jira-mcp-server](https://github.com/OrenGrinker/jira-mcp-server) with custom modifications. Original work by Oren Grinker.
...
|-----------|-------------------|------------------|-------------|
| View my tasks | 6 requests (~3-5s) | 1 request (~0.5-1s) | **5-6x faster** ⚡️ |
